...
public class Arm {
    ...
    public static double armOuttake = 0.60, armSecure = 0.50, armIntake = 0.26, autoArmOuttake = 0.55, armStorage = 0.71, armAutoStorage = 0.70, armAutoStorage2 = 0.75, armPreload = 0.75,
